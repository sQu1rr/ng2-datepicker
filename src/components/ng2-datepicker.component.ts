...
export class DatePickerComponent implements ControlValueAccessor, OnInit {
  ...
  generateYears() {
    let date: moment.Moment = Moment(this.options.minDate) || Moment().year(Moment().year() - 40);
    let toDate: moment.Moment = Moment(this.options.maxDate) || Moment().year(Moment().year() + 40);
